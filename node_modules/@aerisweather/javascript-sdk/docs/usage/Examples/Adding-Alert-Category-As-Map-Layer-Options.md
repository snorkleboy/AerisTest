# Adding Alert Categories as Map Layer Options {.page-title}
...
![Interactive map application with alert categories as layer options.]({{docs-url}}/img/awxjs-example-interactivemapapp-category-map-layer-options.png)
