# Create a Custom Info Panel Content View {.page-title}
...
![Custom interactive map data source example]({{docs-url}}/img/awxjs-example-interactivemapapp-custom-infopanel.png)
