# Display a Basic Observation {.page-title}
...
![Basic observation example]({{docs-url}}/img/awxjs-example-obs-basic.png)
...
<head>
	<meta charset="UTF-8">
	<title>Aeris JavaScript SDK - Basic Observation</title>
    ...
    #obs .details .row div:last-child {
        font-size: 16px;
        font-weight: bold;
    }
    #obs .timestamp {
...
<script>
	...
	window.onload = () => {
		...
		const request = aeris.api().endpoint('observations').place('chicago,il');
