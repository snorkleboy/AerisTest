<h1 id="create-a-custom-map-content-source" class="page-title">Create a Custom Map Content Source</h1>
<p>Create a custom map content source and add it to an interactive map. The following example will setup a vector content source that loads airport observations and renders their latest flight rules as point markers on an interactive map.</p>
<figure>
	<img src="/docs/js/img/awxjs-example-interactivemap-custom-source.png" alt="Custom interactive map data source example" />
...
<head>
	<meta charset="UTF-8">
	<title>
		Aeris JavaScript SDK - Custom Interactive Map Data Source
	</title>
