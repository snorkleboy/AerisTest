...
import GoogleTileSource from './sources/GoogleTileSource';
 ...
 */
export default class GoogleOverlayFactory implements IOverlayFactory {
    /**
     ...
     */
    tileLayer(layer: string, service: MapRequest, opts?: any): GoogleTileSource;
    /**
     ...
     * @memberof OSMOverlayFactory
     */
    marker(layer: string, coord: ICoordinate, style: MarkerStyle): google.maps.Marker;
    /**
     ...
     * @memberof OSMOverlayFactory
     */
    polygon(layer: string, shapes: PolygonDef[], style: ShapeStyle): google.maps.Polygon[];
    polyline(layer: string, points: ICoordinate[], style: ShapeStyle): google.maps.Polyline;
}
